...
#Hallar la mediana
median_sales = statistics.mode(sales)
print(f"La moda es: {median_sales}")

#Hallar la moda
mode_sales = statistics.median(sales)
print(f"La mediana es: {mode_sales}")

#Hallar la desviacion estandar
stedev_sales = statistics.stdev(sales)
print(f"La desviación estandar es: {stedev_sales}")

...
class Concesionario:
    ...
    def mostrar_vehiculos_disponibles(self):
        ...
        for vehiculo in self.vehiculos:
            if vehiculo.disponible:
                print(f"{vehiculo.modelo} por Q{vehiculo.precio}")

# Crear los vehículos
vehiculo1 = Vehiculo("Mitsubishi", 1500)
vehiculo2 = Vehiculo("Mazda", 1600)
vehiculo3 = Vehiculo("VW", 1600)

# Crear cliente
cliente1 = Cliente("Jairo", "001")
